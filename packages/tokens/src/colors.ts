...
export const intentColors = {
  light: {
    primary: {
      base: palette.stone[900],
      hover: palette.stone[800],
      light: palette.stone[100],
      lightHover: palette.stone[200],
      fg: palette.stone[900],
      contrast: "#ffffff"
    },
    secondary: {
      base: palette.stone[300],
      hover: palette.stone[400],
      light: palette.stone[100],
      lightHover: palette.stone[200],
      fg: palette.stone[700],
      contrast: palette.stone[900]
    },
    danger: {
      base: palette.red[600],
      hover: palette.red[700],
      light: palette.red[50],
      lightHover: palette.red[100],
      fg: palette.red[700],
      contrast: "#ffffff"
    },
    success: {
      ...
      lightHover: palette.emerald[100],
      fg: palette.emerald[700],
      contrast: "#ffffff"
    },
    warning: {
      base: palette.amber[600],
      hover: palette.amber[700],
      light: palette.amber[50],
      lightHover: palette.amber[100],
  ...
  dark: {
    primary: {
      base: palette.stone[50],
      hover: palette.stone[200],
      light: palette.stone[800],
      lightHover: palette.stone[700],
      fg: palette.stone[50],
      contrast: palette.stone[900]
    },
    secondary: {
      base: palette.stone[600],
      hover: palette.stone[500],
      light: palette.stone[800],
      lightHover: palette.stone[700],
      fg: palette.stone[300],
      contrast: palette.stone[50]
    },
    danger: {
      base: palette.red[400],
      hover: palette.red[500],
      light: palette.red[700],
      lightHover: palette.red[600],
      fg: palette.red[400],
      contrast: palette.stone[950]
    },
    success: {
      base: palette.emerald[400],
      hover: palette.emerald[500],
      light: palette.emerald[700],
      lightHover: palette.emerald[600],
    ...
    warning: {
      ...
      light: palette.amber[700],
      lightHover: palette.amber[600],
