...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    intent: {
      ...
      table: { type: { summary: '"primary" | "secondary" | "danger" | "success" | "warning"' }, defaultValue: { summary: "primary" } },
    },
    variant: {
      control: "select",
      options: ["filled", "outline", "light", "ghost"],
      description: "ボタンの見た目のスタイル。",
      table: { type: { summary: '"filled" | "outline" | "light" | "ghost"' }, defaultValue: { summary: "filled" } },
    },
    size: {
      control: "select",
      options: ["sm", "md", "lg"],
...
export const Playground: Story = {
  parameters: {
    docs: {
      description: {
        story: "Controls パネルで intent, variant, size 等を自由に切り替えて挙動を確認できる。",
      },
    },
  },
};
...
export const Primary: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "主要なアクション。1画面に1つが目安。フォームの送信やメインのCTAに使う。",
      },
    },
  },
};
...
export const Secondary: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "補助的なアクション。Primary と並べて代替の選択肢を提示する場面で使う。",
      },
    },
  },
};
...
export const Danger: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "破壊的な操作（削除、解除など）。確認ダイアログ内での使用を推奨。",
      },
    },
  },
};
...
export const Filled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "塗りつぶし。最も目立つスタイル。画面内で最も重要なアクションに。",
      },
    },
  },
};
...
export const Outline: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "枠線のみ。Filled と並べて補助的なアクションを示す場面や、フォームのキャンセルに。",
      },
    },
  },
};
...
export const Light: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "薄い背景色。タグ的な用途、フィルター、軽いアクションに。ステータス表示にも適している。",
      },
    },
  },
};
...
export const Ghost: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "背景なし。ツールバー、インライン操作、密集するUIで視覚的ノイズを減らしたい場面で。",
      },
    },
  },
};
...
export const Large: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "CTA やモバイルのタッチターゲットに。最小 48px の高さでタッチ操作しやすい。",
      },
    },
  },
};
...
export const WithLeftIcon: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "左アイコンでアクションの意味を補強する。アイコンは aria-hidden で装飾として扱われる。",
      },
    },
  },
};
...
export const IconOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "アイコンのみのボタン。aria-label が必須。ツールバーや密集UIで使う。",
      },
    },
  },
};
...
export const Loading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "非同期処理中はスピナーを表示し、二重送信を防ぐ。loading=true で自動的に disabled になる。",
      },
    },
  },
};
    ...
    return (
      <div className="space-y-1">
        <div className="grid grid-cols-5 gap-3 px-4 pb-2">
          <div />
          {variants.map((v) => (
            <div key={v.name} className="text-xs font-mono text-stone-400 text-center">
              {v.label}
            </div>
          ))}
        </div>
        {intents.map((intent) => (
          ...
          >
            <div className="text-xs font-mono text-stone-500">{intent.label}</div>
            {variants.map((v) => (
